			...
			<div class="row mt-4">
				...
				<div class="col-md-4">
					...
					<div class="list-group" id="list-tab" role="tablist">
						...
						<a href="#" onclick="getPages(2,this)" class="c-link list-group-item list-group-item-action list-group-item-dark" data-toggle="list" role="tab" aria-current="true">Show My Blogs</a> 
						<% if(user.getRole().equals("admin")) { %>
						<a href="#" onclick="getPages(3,this)" class="c-link list-group-item list-group-item-action list-group-item-dark" data-toggle="list" role="tab" aria-current="true">Show All Blogs</a> 
